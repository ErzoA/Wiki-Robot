        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Source Code", url="https://pornhub.com"
                        ),
                    ],
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="CD Music", url="https://t.me/chnlwiki/138"
                        ),
                        InlineKeyboardButton(
                            text="CD Dev", url="https://t.me/chnlwiki/139"
                        ),
                        InlineKeyboardButton(
                            text="CD Stream", url="https://t.me/chnlwiki/140"
                        ),
                    ],
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Support", url="https://t.me/+n7l_RTC89bRjYmQ1"
                        ),
                        InlineKeyboardButton(
                            text="Updates", url="https://t.me/AboutWiki"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="Go Back", callback_data="Wiki_"),
